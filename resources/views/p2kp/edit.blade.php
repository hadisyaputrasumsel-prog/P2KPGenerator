            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border-collapse border border-slate-200" id="utama-table">
                    ...
                    <tbody class="border-b-4 border-slate-300">
                        ...
                        <tr>
                            <!-- AK -->
                            <td class="p-2 border border-slate-300 align-top bg-white"><input type="number" step="any" name="items[{{ $index }}][credit_score]" value="{{ $item->credit_score + 0 }}" placeholder="AK" class="w-16 border-slate-300 rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500" required></td>
                            <td class="p-2 border border-slate-300 align-top bg-blue-50"><input type="number" step="any" name="items[{{ $index }}][real_credit_score]" value="{{ $item->real_credit_score !== null ? $item->real_credit_score + 0 : '' }}" placeholder="AK" class="w-16 border-slate-300 bg-white rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500"></td>
                            ...
                            <!-- Kualitas -->
                            <td class="p-2 border border-slate-300 align-top bg-white"><div class="flex items-center gap-1"><input type="number" name="items[{{ $index }}][target_quality]" value="{{ $item->target_quality }}" class="w-16 border-slate-300 rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500" required><span class="text-xs text-slate-500">%</span></div></td>
                            <td class="p-2 border border-slate-300 align-top bg-blue-50"><div class="flex items-center gap-1"><input type="number" name="items[{{ $index }}][real_quality]" value="{{ $item->real_quality }}" class="w-16 border-slate-300 bg-white rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500"><span class="text-xs text-slate-500">%</span></div></td>
                ...
                <tr class="bg-slate-100 text-slate-700">
                    ...
                    <th class="px-2 py-1 text-center text-xs font-semibold uppercase border border-slate-300 bg-blue-50">Realisasi</th>
                        ...
                        <tr>
                            ...
                            <!-- Kualitas -->
                            <td class="p-2 border border-slate-300 align-top bg-white"><div class="flex items-center gap-1"><input type="number" name="items[${rowCount}][target_quality]" value="100" class="w-16 border-slate-300 rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500" required><span class="text-xs text-slate-500">%</span></div></td>
                            <td class="p-2 border border-slate-300 align-top bg-blue-50"><div class="flex items-center gap-1"><input type="number" name="items[${rowCount}][real_quality]" value="" class="w-16 border-slate-300 bg-white rounded-md text-sm text-center px-1 py-1.5 focus:ring-indigo-500 focus:border-indigo-500"><span class="text-xs text-slate-500">%</span></div></td>
